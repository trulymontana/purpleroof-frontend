  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-96 space-y-4 p-4 shadow-md">
        ...
        <SelectElement name="residential_status" label={'Residential Status'} options={residentialTypes} />

        <SelectElement name="income_profile" label={'Income Profile'} options={incomeProfiles} />
