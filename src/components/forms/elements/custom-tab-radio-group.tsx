                            ...
                            >
                                {options.map((option) => (
                                    <FormItem key={option.value} className="flex w-full items-center space-x-1 space-y-0 p-1">
                                        ...
                                        <FormLabel
                                            className={`w-full px-4 py-2 rounded-full  cursor-pointer text-center text-[10px] md:text-[16px]  font-medium ${field.value === option.value ? 'bg-white text-primary' : 'text-white'
                                                }`}
                                        >
                                            {option.label}
                                        </FormLabel>
